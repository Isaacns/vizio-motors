/* ============================================================
   Vizio Motors — dados de demonstração (piloto R3)
...
const DADOS = {
  _cfg:{ produto:"Vizio Motors", oficina:"R3 Centro Automotivo",
         especialidade:"Renault Master", perfil:"admin" },
  ...
  servicos:[
    ...
    {id:"S4", nome:"Troca de embreagem (Master)", preco:2600, tempoMin:480, categoria:"Motor/Transmissão"},
  ...
  pecas:[
    {id:"P1", nome:"Kit embreagem Renault Master", custo:1150, preco:1720, estoque:2, minimo:3, fornecedor:"DieselParts"},
    {id:"P2", nome:"Óleo 5W30 (litro)", custo:32, preco:58, estoque:40, minimo:20, fornecedor:"LubMax"},
    {id:"P3", nome:"Filtro de óleo Master", custo:28, preco:62, estoque:14, minimo:8, fornecedor:"DieselParts"},
  ...
  clientes:[
    {id:"C1", nome:"Transportes Bahia Log", tel:"71 99888-1010", email:"frota@bahialog.com", nasc:"2015-03-12", obs:"Frota de 12 Master. Fecha OS por e-mail."},
    ...
    {id:"C4", nome:"Delivery Express ME", tel:"71 99555-8080", email:"contato@deliveryexp.com", nasc:"2019-01-30", obs:"3 furgões Master."},
    {id:"C5", nome:"Carlos Menezes", tel:"71 99444-1200", email:"carlosm@gmail.com", nasc:"1978-09-18", obs:"Cliente desde 2020."}
  ],
  veiculos:[
    {id:"V1", clienteId:"C1", placa:"RJZ-1D23", modelo:"Renault Master 2.3 L2H2", ano:2021, km:78400, cor:"Branco", combustivel:"Diesel"},
    {id:"V2", clienteId:"C2", placa:"PQR-8H45", modelo:"Renault Master L3H2 Furgão", ano:2019, km:59200, cor:"Prata", combustivel:"Diesel"},
    {id:"V3", clienteId:"C3", placa:"ABC-2F10", modelo:"Renault Master Furgão", ano:2020, km:41200, cor:"Branco", combustivel:"Diesel"},
    {id:"V4", clienteId:"C4", placa:"MST-7K99", modelo:"Renault Master Minibus 16L", ano:2022, km:33150, cor:"Branco", combustivel:"Diesel"},
    {id:"V5", clienteId:"C5", placa:"GHT-3B77", modelo:"Renault Master 2.3", ano:2018, km:96800, cor:"Cinza", combustivel:"Diesel"},
    {id:"V6", clienteId:"C1", placa:"RJZ-4C88", modelo:"Renault Master L2H2", ano:2021, km:71000, cor:"Branco", combustivel:"Diesel"}
  ],
  // statusIdx = índice em STATUS_FLOW
  os:[
    {id:"OS1", numero:1042, clienteId:"C1", veiculoId:"V1", entrada:"2026-07-03", previsao:"2026-07-04",
     responsavel:"Carlos (mecânico)", statusIdx:4, aprovado:true, token:"r3-1042",
    ...
    {id:"OS2", numero:1043, clienteId:"C2", veiculoId:"V2", entrada:"2026-07-03", previsao:"2026-07-03",
     responsavel:"André (mecânico)", statusIdx:3, aprovado:true, token:"r3-1043",
    ...
    {id:"OS3", numero:1044, clienteId:"C3", veiculoId:"V3", entrada:"2026-07-03", previsao:"2026-07-04",
     responsavel:"André (mecânico)", statusIdx:1, aprovado:false, token:"r3-1044",
    ...
    {id:"OS4", numero:1045, clienteId:"C4", veiculoId:"V4", entrada:"2026-07-02", previsao:"2026-07-03",
     responsavel:"Carlos (mecânico)", statusIdx:5, aprovado:true, token:"r3-1045",
    ...
    {id:"OS5", numero:1046, clienteId:"C5", veiculoId:"V5", entrada:"2026-07-01", previsao:"2026-07-02",
     responsavel:"André (mecânico)", statusIdx:8, aprovado:true, token:"r3-1046",
